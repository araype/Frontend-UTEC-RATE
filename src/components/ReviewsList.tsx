...
function ReviewsList({ reviews }: ReviewsListProps) {
  ...
  return (
    <section className="glass-panel rounded-[2rem] p-6 border border-card-border shadow-2xl h-full">
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-foreground font-display">Opiniones</h2>
        ...
        <div className="space-y-4">
          {pagedReviews.map((review, i) => (
            <article
              ...
              className="animate-review-enter group rounded-2xl border border-card-border bg-foreground/[0.02] p-5 transition-all duration-300 hover:bg-foreground/[0.04] hover:border-primary/30"
            >
              <div className="flex items-start justify-between gap-4 mb-4">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-full bg-gradient-to-br from-slate-700 to-slate-800 flex items-center justify-center border border-card-border text-white font-bold text-xs">
                    {review.author.split(' ').map(n => n[0]).join('')}
                  </div>
                  <div>
                    <p className="text-sm font-bold text-foreground leading-none mb-1">{review.author}</p>
                ...
                <div className="rounded-xl bg-foreground/5 px-2 py-1.5 border border-card-border">
              ...
              <div className="relative">
                ...
                <div className="absolute -top-2 -left-2 opacity-[0.03] text-foreground">
