      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="glass-panel rounded-[2.5rem] p-8 md:p-12 border border-card-border shadow-2xl">
          <header className="mb-10 text-center">
            <div className="mx-auto mb-6 flex h-20 w-20 animate-float items-center justify-center rounded-2xl bg-white border border-card-border shadow-lg shadow-primary/20 overflow-hidden">
              <img
                src="/urate_logo.png"
                alt="URATE"
            ...
            <div className="inline-flex items-center gap-2 rounded-full bg-foreground/5 px-4 py-1.5 border border-card-border mb-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-card-border bg-foreground/5 px-12 py-4 text-foreground placeholder:text-foreground/20 outline-none transition-all focus:border-primary/50 focus:bg-foreground/10 focus:ring-4 focus:ring-primary/10"
